      ...
      <nav className="bg-gray-600 text-white mx-auto px-4 py-0"> 
        <div className="max-w-[1400px] mx-auto px- flex justify-between items-center">
          <ul className="flex list-none m-0 p-0 gap-8">
            ...
            <li><Link href="/academia" className="text-white no-underline py-4 block text-sm hover:text-primary transition-colors">Academia de Profissionais</Link></li>
            <li><Link href="/blog" className="text-white no-underline py-4 block text-sm hover:text-primary transition-colors">Blog</Link></li>
            <li><Link href="/ofertas" className="text-white no-underline py-4 block text-sm hover:text-primary transition-colors">Max por Menos</Link></li>
